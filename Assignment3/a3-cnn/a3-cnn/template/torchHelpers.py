...
class Trainer:
    ...
    def _logMetrics(self, epoch):       
        ...
        self.logger.info(f'Throughput: {self.metrics["throughput"] :.3f} img/s  |')
    ...
    def _trainEpoch(self, epoch, trainLoader):
        ...
        for i, data in enumerate(trainLoader, 0):        
            ...
            # throughput (images per second)
            self.metrics["throughput"].append(images.shape[0] / (batchEndTime - batchStartTime))
